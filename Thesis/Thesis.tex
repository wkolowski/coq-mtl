...
\begin{thebibliography}{1}
    ...
    \bibitem{AppelHaken1}
        ...
        \textit{Every map is four colourable}, 1976, \\
    ...
    \bibitem{AppelHaken3}
        Kenneth Appel, Wolfgang Haken, \\
        \textit{Every  map  is  four  colourable,  Part  II:  Reducibility}, 1977, \\
        \url{https://projecteuclid.org/euclid.ijm/1256049012}

    \bibitem{AppelHaken4}
        Kenneth Appel, Wolfgang Haken,
        \textit{Every  map  is  four  colourable}, 1989, \\
    ...
    \bibitem{MERC}
        ...
        \textit{Experimenting with Monadic EquationalReasoning in Coq}, 2018, \\

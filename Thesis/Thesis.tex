...
This concludes our introduction to the Coq proof assistant. From now on we will assume that the reader is familiar with it. If that's not the case, recently a great many books have been written which make a great introduction:

...
Are we so lucky that all proofs whatsoever go through just by \m{reflexivity}, like for the Church-encoded monads and monad transformers? Of course not -- most proofs require something more than just \m{reflexivity}.
...
\begin{listing}[H]
    ...
    {Coq}{../Thesis/snippets/BasicTactics.v}

...
#[global] Hint Rewrite @bind_pure_l @bind_pure_r @bind_assoc @bind_ap : CoqMTL.
...
Proof.
  ...
  - now rewrite <- bind_ap, fmap_pure_ap.
  - now rewrite bind_pure_l.
Qed.

End DerivedMonadLaws.

#[global] Hint Rewrite @fmap_bind_pure @bind_fmap @fmap_bind : CoqMTL.
...
Proof.
  intros.
  unfold constrA, const, compose, id. hs.
  f_equal; ext a.
  f_equal; ext b.
  now rewrite bind_pure_l, bind_pure_r.
Qed.
...
Proof.
  unfold constrA, const, compose, id.
  monad.
  unfold compose.
  now rewrite bind_pure_r.
Qed.
...
Proof.
  intros.
  rewrite constrA_spec, bind_assoc.
  f_equal; ext a.
  now apply constrA_spec.
Qed.

End DerivedMonadLaws2.

#[global] Hint Rewrite @constlA_spec @constrA_spec : CoqMTL.
